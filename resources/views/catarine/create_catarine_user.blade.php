                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form method="post" action="{{ URL::to('post-user-data') }}" enctype="multipart/form-data">
                                        @csrf
                                        <h4 class="header-title">Create Catarine User</h4>
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Company Name</label>
                                            <input class="form-control" name="company_name" type="text" value="{{ old('company_name') }}" id="example-text-input">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="zip_code" type="text" value="{{ old('zip_code') }}" id="example-text-input">
                                        </div>

                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Contact Email/Phone</label>
                                            <input class="form-control" name="alt_number" type="text" value="{{ old('alt_number') }}" id="example-text-input">
                                        </div>

                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Contact Person Firstname</label>
                                            <input class="form-control" name="contact_first_name" type="text" value="{{ old('contact_first_name') }}" id="example-text-input">
                                        </div>
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Contact Person Lastname</label>
                                            <input class="form-control" name="contact_last_name" type="text" value="{{ old('contact_last_name') }}" id="example-text-input">
                                        </div>
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Website</label>
                                            <input class="form-control" name="website" type="text" value="{{ old('website') }}" id="example-text-input">
                                        </div>
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Email</label>
                                            <input class="form-control" name="email" type="text" value="{{ old('email') }}" id="example-text-input">
                                        </div>
                                        <div class="form-group">
